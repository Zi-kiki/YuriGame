...
static void invokeAppMain(NSString *selectedApp, int argc, char *argv[]) {
    ...
    *_CFGetProcessPath() = appBundle.executablePath.UTF8String;
    ...
    NSMutableArray *oa = NSProcessInfo.processInfo.arguments.mutableCopy;
    oa[0] = appBundle.executablePath;
    [NSProcessInfo.processInfo performSelector:@selector(setArguments:) withObject:oa];
